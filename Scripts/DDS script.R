...
TZA2008 <- left_join(TZA2008, DDS2008total); rm(DDS2008total, DDS2008)
...
TZA2010 <- left_join(TZA2010, DDS2010total); rm(DDS2010total, DDS2010)
...
TZA2012 <- left_join(TZA2012, DDS2012total); rm(DDS2012total, DDS2012)
#saveRDS(TZA2012, file.path(dataPath, "TZA2012n.rds"))
