...
Age <-
  select(HH12,y3_hhid, indidy3, infants, children, young_adults,mature_adults, older_adults) %>% 
  replace(is.na(.), 0) %>%
  group_by(y3_hhid) %>% 
...
HH12 <- select(HH12, -infants, -children, -young_adults, -mature_adults, -older_adults)
