...
Age <-
  select(HH10,y2_hhid, indidy2, infants, children, young_adults,mature_adults, older_adults) %>% 
  replace(is.na(.), 0) %>%
  group_by(y2_hhid) %>% 
...
HH10 <- select(HH10, -infants, -children, -young_adults, -mature_adults, -older_adults)
