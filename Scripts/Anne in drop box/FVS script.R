...
saveRDS(FVS2008, file.path(dataPath, "FVS2008.rds"))
...
saveRDS(FVS2010, file.path(dataPath, "FVS2010.rds"))

rm(FVS2010, HH_SEC_K1)
...
saveRDS(FVS2012, file.path(dataPath, "FVS2012.rds"))

rm(FVS2012, HH_SEC_J1)
